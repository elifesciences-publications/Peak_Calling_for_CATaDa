...
system("$dir/sub_programs/RPM_normalise_and_average.pl", "$exp_name", "$paths", "$rep_num");  #starts perl prog to make RPM normalised files and average file
